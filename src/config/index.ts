...
File Safety Rules:
- ALWAYS add "use client" (WITH QUOTES — this is a string directive, like "use strict") to the TOP, THE FIRST LINE of app/page.tsx and any other relevant files which use browser APIs or react hooks
- The directive MUST be a quoted string: "use client" — writing use client WITHOUT quotes will cause a fatal parse error
- Correct: "use client" or 'use client' — Incorrect: use client
